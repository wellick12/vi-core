...
These charts are highly customizable, very easy to implement and **scale to the resolution of the display of the driver to provide sharp charts even on retina displays**.
